...
- [x] 本番確認：公開後の外部リンク、favicon、OG表示を実URLで確認する

## 7. GitHub連携とアカウント境界

- [x] 継続管理できる個人CloudflareアカウントのWorkers Freeを公開先にする
- [x] 個人アカウントのWorkers BuildsでGitHubリポジトリを接続する
- [x] 2026年9月末に管理権限が止まるODH Paid相当チームを本番所有先にしない
...
- [x] 本番確認：canonical設定のデプロイ後、canonical・OG URLを実HTMLで確認する

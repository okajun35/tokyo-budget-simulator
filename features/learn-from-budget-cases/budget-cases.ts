...
export const BUDGET_CASES = [
  ...
  {
    id: "case-giga-device-investment",
    title: "GIGAスクール構想による端末整備",
    categoryIds: ["education"],
    direction: "increase",
    jurisdiction: "日本の38事業主体",
    country: "日本",
    period: "2021年度から2024年4月",
    budgetContext:
      "高校生等の学習機会を支えるため、国の補助で学習者用コンピュータを追加整備",
    changeTypes: ["capital_investment", "service_expansion"],
    whatChanged:
      "38事業主体が高校生等へ貸与する学習者用コンピュータ95,554台を整備し、国庫補助金38億1,309万円余を交付しました。",
    confirmedChanges: [
      "2024年4月末までの最大貸与台数は62,752台",
      "整備台数と最大貸与台数の間に32,802台の開差",
      "14事業主体では最大貸与率が50%未満",
      "会計検査院は貸与促進と未貸与端末の活用方法に関する情報提供を求めた",
    ],
    whatRemainsUnknown:
      "端末を整備しても、対象者の需要把握や貸与・活用の運用が整わなければ利用へ結び付かないことを示します。この資料は端末整備による学習成果を確認したものではなく、東京都で同じ利用状況になるとも限りません。",
    evidenceLevel: 1,
    sourceKind: "national_audit_office",
    sourceUrl:
      "https://report.jbaudit.go.jp/org/r05/2023-r05-0138-0.htm",
    sourceTitle: "令和5年度決算検査報告 GIGAスクール構想で高校に整備された学習者用コンピュータ",
    sourceDate: "2024-10-15",
    retrievedAt: "2026-08-11",
  },
  {
    id: "case-england-adult-social-care-increase",
    title: "英国政府が成人社会福祉への追加資金を表明",
    categoryIds: ["welfare"],
    direction: "increase",
    jurisdiction: "イングランドの地方自治体",
    country: "イギリス",
    period: "2023年度",
    budgetContext:
      "物価上昇、待機者、病院からの退院遅延など、成人社会福祉の費用と需要への圧力",
    changeTypes: ["capacity_expansion", "service_expansion"],
    whatChanged:
      "英国政府は成人社会福祉へ最大75億ポンドを投入する方針を示し、そのうち27億ポンドを新たな中央政府資金としました。",
    confirmedChanges: [
      "NAOは追加措置が地方自治体に一定の救済をもたらしたと評価",
      "地方自治体全体では費用圧力を賄う支出を予定していると政府が推計",
      "一方で約4分の1の自治体は費用圧力に追いつかない可能性",
      "6分の1の自治体は需要が供給能力を上回ると予想",
    ],
    whatRemainsUnknown:
      "追加資金があっても、地域別の需要、配分方式、待機者、約15万2,000人の欠員などの制約が残りました。資金増だけで必要な介護サービスを確保できるとは限らず、東京都へ同じ結果を当てはめられません。",
    evidenceLevel: 2,
    sourceKind: "national_audit_office",
    sourceUrl:
      "https://www.nao.org.uk/press-releases/reforming-adult-social-care-in-england/",
    sourceTitle: "Reforming adult social care in England",
    sourceDate: "2023",
    retrievedAt: "2026-08-11",
  },
  {
    id: "case-us-iija-infrastructure-investment",
    title: "米国の大規模インフラ投資と事業化の制約",
    categoryIds: ["city"],
    direction: "increase",
    jurisdiction: "アメリカ合衆国の州・地方政府等",
    country: "アメリカ合衆国",
    period: "2021年から2025年",
    budgetContext:
      "道路や橋梁などの交通インフラへ大規模な追加投資を行うための連邦法",
    changeTypes: ["capital_investment"],
    whatChanged:
      "Infrastructure Investment and Jobs Actにより、米運輸省の約100の助成制度へ5,510億ドル超を配分しました。",
    confirmedChanges: [
      "2025年4月時点で利用可能な資金の59%を義務化",
      "助成先はインフレによる事業費上昇、予算・工程の再設定、環境審査などを課題として報告",
      "調査対象の2022年度助成事業では約23%が回答時点で契約未締結",
      "GAOは運輸省に事業実施リスクの包括的な評価と対応を勧告",
    ],
    whatRemainsUnknown:
      "予算を確保しても、価格上昇、契約、審査、工程管理の能力がなければ事業化が遅れることを示します。全資金の成果や完成後の便益を確認した資料ではなく、東京都で同じ制約や成果になるとは限りません。",
    evidenceLevel: 2,
    sourceKind: "national_audit_office",
    sourceUrl: "https://www.gao.gov/products/gao-25-107166",
    sourceTitle: "Infrastructure Investment and Jobs Act: DOT Should Better Communicate Funding Status and Assess Risks",
    sourceDate: "2025-07-24",
    retrievedAt: "2026-08-11",
  },
